        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-500">Total Diagnosa</p>
                <p className="text-2xl font-bold text-gray-900">{stats.totalDiagnosa}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-500">Total Gejala</p>
                <p className="text-2xl font-bold text-gray-900">{stats.totalGejala}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">FC + CF</p>
              </div>
            </div>
          </CardContent>
        </Card>
